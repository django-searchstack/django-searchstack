...
from searchstack.utils import _lookup_identifier_method, get_facet_field_name, get_identifier, Highlighter, log
...
class GetFacetFieldNameTestCase(TestCase):
    ...
    @override_settings(SEARCHSTACK_IDENTIFIER_METHOD='test_searchstack.core.custom_identifier.get_identifier_method')
    def test_searchstack_identifier_method(self):
        get_identifier = _lookup_identifier_method()
        self.assertEqual(get_identifier('a.b.c'), 'a.b.c')

    @override_settings(SEARCHSTACK_IDENTIFIER_METHOD='test_searchstack.core.custom_identifier.not_there')
    def test_searchstack_identifier_method_bad_path(self):
    ...
    def test_searchstack_identifier_method_bad_module(self):

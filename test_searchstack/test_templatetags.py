...
from searchstack.utils import Highlighter
...
"""
    ...
    @override_settings(SEARCHSTACK_CUSTOM_HIGHLIGHTER='not.here.FooHighlighter')
    ...
    @override_settings(SEARCHSTACK_CUSTOM_HIGHLIGHTER='test_searchstack.test_templatetags.BorkHighlighter')

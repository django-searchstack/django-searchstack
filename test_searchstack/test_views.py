...
from searchstack.forms import FacetedSearchForm, ModelSearchForm, SearchForm
from searchstack.query import EmptySearchQuerySet
from searchstack.utils.loading import UnifiedIndex
from searchstack.views import FacetedSearchView, search_view_factory, SearchView
...
class SearchViewTestCase(TestCase):
    ...
    def test_search_no_query(self):
        response = self.client.get(reverse('searchstack_search'))
        self.assertEqual(response.status_code, 200)

    def test_search_query(self):
        response = self.client.get(reverse('searchstack_search'), {'q': 'haystack'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_invalid_page(self):
        response = self.client.get(reverse('searchstack_search'), {'q': 'haystack', 'page': '165233'})
    ...
    def test_pagination(self):
        response = self.client.get(reverse('searchstack_search'), {'q': 'haystack', 'page': 0})
        self.assertEqual(response.status_code, 404)
        response = self.client.get(reverse('searchstack_search'), {'q': 'haystack', 'page': 1})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.context[-1]['page'].object_list), 3)
        response = self.client.get(reverse('searchstack_search'), {'q': 'haystack', 'page': 2})
        self.assertEqual(response.status_code, 404)
...
class ResultsPerPageTestCase(TestCase):
    fixtures = ['initial_data.json']
    urls = 'test_searchstack.results_per_page_urls'
...
class FacetedSearchViewTestCase(TestCase):
    ...
    def test_search_no_query(self):
        response = self.client.get(reverse('searchstack_faceted_search'))
        self.assertEqual(response.status_code, 200)
...
class BasicSearchViewTestCase(TestCase):
    ...
    def test_search_no_query(self):
        response = self.client.get(reverse('searchstack_basic_search'))
        self.assertEqual(response.status_code, 200)

    def test_search_query(self):
        response = self.client.get(reverse('searchstack_basic_search'), {'q': 'haystack'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_invalid_page(self):
        response = self.client.get(reverse('searchstack_basic_search'), {'q': 'haystack', 'page': '165233'})
        self.assertEqual(response.status_code, 404)
